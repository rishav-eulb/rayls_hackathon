...
#### 1. "Hardhat-foundry plugin error"
...
**Problem**: Missing dependencies or wrong Solidity version
...
**Problem**: Not enough gas for deployment

**Solution**:
- Get testnet ETH from Rayls faucet
- Check balance: `cast balance $YOUR_ADDRESS --rpc-url $RAYLS_RPC_URL`

#### 4. "STRATEGIES environment variable not set"
...
# NOT:
STRATEGIES=["0x...","0x..."]  # ❌ Wrong format
```

#### 5. "execution reverted"

**Problem**: Permission denied or contract not initialized

**Solution**:
- Check you're the registry owner
- Verify strategy is linked to vault
...
1. Check [VERIFICATION_GUIDE.md](./VERIFICATION_GUIDE.md) for verification issues
2. Check [STRATEGY_DEPLOYMENT.md](./STRATEGY_DEPLOYMENT.md) for deployment details
3. Check [ERC4626_STRATEGY_GUIDE.md](./ERC4626_STRATEGY_GUIDE.md) for architecture info
4. Review deployment logs in `deployments/` directory
5. Check contract on explorer: https://devnet-explorer.rayls.com

## 📖 Additional Documentation

- [Verification Guide](./VERIFICATION_GUIDE.md) - Contract verification
- [Strategy Deployment Guide](./STRATEGY_DEPLOYMENT.md) - Detailed deployment steps
- [ERC4626 Strategy Guide](./ERC4626_STRATEGY_GUIDE.md) - Architecture details
- [Frontend Setup Guide](./FRONTEND_SETUP.md) - Frontend configuration

## 🔐 Security

- **Private Keys**: Never commit or share private keys
- **API Keys**: Keep in `.env.local`, add to `.gitignore`
- **Smart Contracts**: Audited architecture patterns
...
- Rayls network for infrastructure
- ERC4626 Alliance for vault standards

## 📞 Support

- **GitHub Issues**: [Report bugs](https://github.com/rishav-eulb/rayls_hackathon/issues)
- **Documentation**: Check guides in the repo
