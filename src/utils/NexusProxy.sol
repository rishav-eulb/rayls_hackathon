...
contract NexusProxy {
    ...
    bytes32 internal constant IMPLEMENTATION_SLOT = 0xc5f16f0fcc639fa48a6947836d9850f504798523bf8c9a3a87d5876cf622bcf7;
    ...
    function _proxy_call() internal {
        assembly {
            ...
            let result := delegatecall(gas(), sload(IMPLEMENTATION_SLOT), 0x0, calldatasize(), 0, 0)
